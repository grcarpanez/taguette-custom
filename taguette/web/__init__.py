...
def make_app(config, debug=False, xsrf_cookies=True):
    routes = [
        ...
        UnbakedURLSpec('/project/([0-9]+)/export/codebook\\.ttl',
                       export.ExportCodebookTtl,
                       name='export_codebook_ttl'),
        UnbakedURLSpec('/project/([0-9]+)/export/codebook_tree\\.html',
                       export.ExportCodebookTreeHtml,
                       name='export_codebook_tree_html'),
        UnbakedURLSpec('/project/([0-9]+)/export/ontotext\\.csv',
                       export.ExportOntotextCsv,
                       name='export_ontotext_csv'),
        UnbakedURLSpec('/project/([0-9]+)/export/ontotext_mapping\\.json',
                       export.ExportOntotextMappingJson,
                       name='export_ontotext_mapping_json'),
